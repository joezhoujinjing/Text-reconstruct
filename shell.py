...
def repl(unigramCost, bigramCost, possibleFills, command=None):
    ...
    while True:
        ...
        if cmd == 'help':
            ...
            print ''
            print '  ' + ' '.join(
                text_reconstruct.segmentWords(part, unigramCost) for part in parts)
            ...
            print ''
            print '  ' + text_reconstruct.insertVowels(ws, bigramCost, possibleFills)
            ...
            print ''
            print '  ' + ' '.join(
                text_reconstruct.segmentAndInsert(part, smoothCost, possibleFills)
                for part in parts
            )
